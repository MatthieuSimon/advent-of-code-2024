def check_path(grid, zero, row_length, column_length):
    ...
    for row_direction, col_direction in [(-1, 0), (1,0), (0, 1), (0, -1)]:
        ...
        if 0 <= next_row < row_length and 0 <= next_col < column_length and grid[next_row][next_col] == value + 1: 
            result += check_path(grid, next_check, row_length, column_length)
